...
class CohortTermsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cohort_term" do
    assert_difference('CohortTerm.count') do
      post cohort_terms_url, params: { cohort_term: { cohort_id: @cohort_term.cohort_id, end_date: @cohort_term.end_date, name: @cohort_term.name, start_date: @cohort_term.start_date } }, as: :json
    end
  ...
  test "should update cohort_term" do
    patch cohort_term_url(@cohort_term), params: { cohort_term: { cohort_id: @cohort_term.cohort_id, end_date: @cohort_term.end_date, name: @cohort_term.name, start_date: @cohort_term.start_date } }, as: :json
    assert_response 200
  end
