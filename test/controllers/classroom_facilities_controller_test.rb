...
class ClassroomFacilitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create classroom_facility' do
    assert_difference('ClassroomFacility.count') do
      post classroom_facilities_url,
           params: { classroom_facility: { description: @classroom_facility.description, name: @classroom_facility.name, quantity: @classroom_facility.quantity } }, as: :json
    end
  ...
  test 'should update classroom_facility' do
    patch classroom_facility_url(@classroom_facility),
          params: { classroom_facility: { description: @classroom_facility.description, name: @classroom_facility.name, quantity: @classroom_facility.quantity } }, as: :json
    assert_response 200
  end
