...
class TestTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create test_type" do
    assert_difference('TestType.count') do
      post test_types_url, params: { test_type: { description: @test_type.description, name: @test_type.name, scale: @test_type.scale } }, as: :json
    end
  ...
  test "should update test_type" do
    patch test_type_url(@test_type), params: { test_type: { description: @test_type.description, name: @test_type.name, scale: @test_type.scale } }, as: :json
    assert_response 200
  end
