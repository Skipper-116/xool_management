...
class PersonNamesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create person_name' do
    assert_difference('PersonName.count') do
      post person_names_url,
           params: { person_name: { family_name: @person_name.family_name, given_name: @person_name.given_name, maiden_name: @person_name.maiden_name, middle_name: @person_name.middle_name, person_id: @person_name.person_id } }, as: :json
    end
  ...
  test 'should update person_name' do
    patch person_name_url(@person_name),
          params: { person_name: { family_name: @person_name.family_name, given_name: @person_name.given_name, maiden_name: @person_name.maiden_name, middle_name: @person_name.middle_name, person_id: @person_name.person_id } }, as: :json
    assert_response 200
  end
