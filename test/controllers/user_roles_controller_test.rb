...
class UserRolesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_role" do
    assert_difference('UserRole.count') do
      post user_roles_url, params: { user_role: { person_id: @user_role.person_id, role_id: @user_role.role_id } }, as: :json
    end
  ...
  test "should update user_role" do
    patch user_role_url(@user_role), params: { user_role: { person_id: @user_role.person_id, role_id: @user_role.role_id } }, as: :json
    assert_response 200
  end
