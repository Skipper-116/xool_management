...
class PersonAttributesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create person_attribute' do
    assert_difference('PersonAttribute.count') do
      post person_attributes_url,
           params: { person_attribute: { attribute_value: @person_attribute.attribute_value, person_attribute_type_id: @person_attribute.person_attribute_type_id, person_id: @person_attribute.person_id } }, as: :json
    end
  ...
  test 'should update person_attribute' do
    patch person_attribute_url(@person_attribute),
          params: { person_attribute: { attribute_value: @person_attribute.attribute_value, person_attribute_type_id: @person_attribute.person_attribute_type_id, person_id: @person_attribute.person_id } }, as: :json
    assert_response 200
  end
