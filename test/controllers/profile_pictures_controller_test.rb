...
class ProfilePicturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create profile_picture" do
    assert_difference('ProfilePicture.count') do
      post profile_pictures_url, params: { profile_picture: { image_url: @profile_picture.image_url, person_id: @profile_picture.person_id } }, as: :json
    end
  ...
  test "should update profile_picture" do
    patch profile_picture_url(@profile_picture), params: { profile_picture: { image_url: @profile_picture.image_url, person_id: @profile_picture.person_id } }, as: :json
    assert_response 200
  end
