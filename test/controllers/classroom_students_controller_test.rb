...
class ClassroomStudentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create classroom_student" do
    assert_difference('ClassroomStudent.count') do
      post classroom_students_url, params: { classroom_student: { classroom_id: @classroom_student.classroom_id, cohort_term_id: @classroom_student.cohort_term_id, person_id: @classroom_student.person_id } }, as: :json
    end
  ...
  test "should update classroom_student" do
    patch classroom_student_url(@classroom_student), params: { classroom_student: { classroom_id: @classroom_student.classroom_id, cohort_term_id: @classroom_student.cohort_term_id, person_id: @classroom_student.person_id } }, as: :json
    assert_response 200
  end
