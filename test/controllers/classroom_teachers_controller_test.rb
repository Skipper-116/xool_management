...
class ClassroomTeachersControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create classroom_teacher' do
    assert_difference('ClassroomTeacher.count') do
      post classroom_teachers_url,
           params: { classroom_teacher: { classroom_id: @classroom_teacher.classroom_id, cohort_term_id: @classroom_teacher.cohort_term_id, person_id: @classroom_teacher.person_id } }, as: :json
    end
  ...
  test 'should update classroom_teacher' do
    patch classroom_teacher_url(@classroom_teacher),
          params: { classroom_teacher: { classroom_id: @classroom_teacher.classroom_id, cohort_term_id: @classroom_teacher.cohort_term_id, person_id: @classroom_teacher.person_id } }, as: :json
    assert_response 200
  end
